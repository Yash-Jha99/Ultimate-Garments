...
const AccountMenu = () => {
  ...
  let { name, mobileNumber } = useSelector((state) => state.auth.user);
          ...
          {subcategories.map((subcategory) => (
            ...
            >
              <MenuItem
                ...
                onClick={() => {
                  handleClose();
                  router.push(`/category/${category}/${subcategory.name}`);
                }}
              >
                {subcategory.name}
              </MenuItem>
...
const Header = (props) => {
  ...
  const drawer = (
    <Box onClick={handleDrawerToggle} sx={{ textAlign: "center" }}>
      <Box py={2}>
        <Image src={Logo} alt="Ultimate Garments" width={150} />
      </Box>
      <Divider />
      <List>
        ...
        <AppBar component="nav" color="inherit">
          <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
            ...
            >
              ...
              <Link href="/">
                <Image src={Logo} priority alt="Ultimate Garments" width={80} />
              </Link>
              ...
              {auth.isLoggedIn ? (
                ...
                <Button
                  ...
                  sx={{
                    ...
                    visibility:
                      router.pathname === "/login" ? "hidden" : "visible",
                  }}
              ...
              {showSearch && (
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => {
                      router("/search/" + searchRef.current.value);
                      setShowSearch(false);
                    }}
                  >
                    Search
